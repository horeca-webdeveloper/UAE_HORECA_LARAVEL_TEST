...
AdminHelper::registerRoutes(function () {
    ...
    Route::group(['prefix' => 'tools/data-synchronize/import/product-inventory', 'as' => 'ecommerce.product-inventory.import.'], function () {
    ...
    Route::group(['prefix' => 'tools/data-synchronize/export/product-inventory', 'as' => 'ecommerce.product-inventory.export.'], function () {
