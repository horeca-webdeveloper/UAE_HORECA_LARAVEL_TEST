...
AdminHelper::registerRoutes(function () {
    Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers', 'prefix' => 'ecommerce'], function () {
        ...
        Route::group(['prefix' => 'product-types', 'as' => 'product-types.'], function () {
            Route::resource('', 'ProductTypesController')
                ->parameters(['' => 'product-types']);

            Route::get('all', [
                'as' => 'all',
                'uses' => 'ProductTypesController@getAllTypes',
        ...
        Route::group(['prefix' => 'products', 'as' => 'products.'], function () {
            Route::get('edit-content/{product}', [
                'as' => 'edit-content',
                'uses' => 'ProductController@editContent', // Make sure this method exists
                'permission' => 'products.edit-content',
            ])->wherePrimaryKey(); // If you're using a primary key condition
        });
